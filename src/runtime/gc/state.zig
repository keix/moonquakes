...
pub const GC = struct {
    ...
    pub const tableExtendArray = mutation_mod.tableExtendArray;
    ...
    pub const allocCClosure = alloc_mod.allocCClosure;
    pub const allocDynamicLibrary = alloc_mod.allocDynamicLibrary;
